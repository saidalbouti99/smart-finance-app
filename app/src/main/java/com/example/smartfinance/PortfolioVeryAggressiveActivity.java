...
public class PortfolioVeryAggressiveActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portfolio_very_aggressive);
        spinner=findViewById(R.id.spinner_very_aggressive);
        et_amount=findViewById(R.id.et_robo_very_aggressive_amount);
        btn_proceed=findViewById(R.id.btn_proceed_very_aggressive);

        mFirebaseAuth = FirebaseAuth.getInstance();
        mFirestore = FirebaseFirestore.getInstance();
        sessionManager = new SessionManager(PortfolioVeryAggressiveActivity.this);
        ...
        btn_proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( et_amount.getText().toString().isEmpty()) {
                    ...
                    et_amount.requestFocus();
                    AlertDialog.Builder builder= builder = new AlertDialog.Builder(PortfolioVeryAggressiveActivity.this);
                    ...
                    Intent intent = new Intent(getApplicationContext(), PortfolioVeryAggressiveResultActivity.class);
        ...
        if (initializedView ==  true) {
            ...
            if (text.equals("1 Year")){
                ...
                try {
                    ...
                    result=Math.round(1.0991*vc);
                    String n=String.valueOf(result);
                    sessionManager.createVAsession(n);
                ...
                try {
                    vc = Double.valueOf(et_amount.getText().toString());
                    result=1.0991*vc;
                    result2=Math.round(1.0991*result);
                ...
                try {
                    ...
                    result2=1.0991*result;
                    result2=1.0991*result2;
                    result2=1.0991*result2;
                    result2=Math.round(1.0991*result2);
                    String n=String.valueOf(result2);
                    sessionManager.createVAsession(n);
