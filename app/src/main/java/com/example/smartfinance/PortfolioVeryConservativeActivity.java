...
public class PortfolioVeryConservativeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portfolio_very_conservative);
        spinner=findViewById(R.id.spinner_very_conservative);
        et_amount=findViewById(R.id.et_robo_very_conservative_amount);
        btn_proceed=findViewById(R.id.btn_proceed_very_conservative);

        mFirebaseAuth = FirebaseAuth.getInstance();
        mFirestore = FirebaseFirestore.getInstance();
        sessionManager = new SessionManager(PortfolioVeryConservativeActivity.this);
        ...
        btn_proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( et_amount.getText().toString().isEmpty()) {
                    ...
                    et_amount.requestFocus();
                    AlertDialog.Builder builder= builder = new AlertDialog.Builder(PortfolioVeryConservativeActivity.this);
                    ...
                    Intent intent = new Intent(getApplicationContext(), PortfolioVeryConservativeResultActivity.class);
        ...
        if (initializedView ==  true) {
            ...
            if (text.equals("1 Year")){
                ...
                try {
                    ...
                    result=Math.round(1.0451*vc);
                    String n=String.valueOf(result);
                    sessionManager.createVCsession(n);
                ...
                try {
                    vc = Double.valueOf(et_amount.getText().toString());
                    result=1.0451*vc;
                    result2=Math.round(1.0451*result);
                ...
                try {
                    vc = Double.valueOf(et_amount.getText().toString());
                    result=1.0451*vc;
                    result2=1.0451*result;
                    result2=1.0451*result2;
                    result2=1.0451*result2;
                    result2=Math.round(1.0451*result2);
                    String n=String.valueOf(result2);
                    sessionManager.createVCsession(n);
